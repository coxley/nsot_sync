# -*- coding: utf-8 -*-
#
# nsot_sync documentation build configuration file, created by
# sphinx-quickstart on Sun Feb 28 18:14:19 2016.
#
...
project = u'nsot_sync'
copyright = u'2016, Codey Oxley'
author = u'Codey Oxley'
...
setup_py_path = os.path.join(os.path.abspath('..'), 'setup.py')
with open(setup_py_path) as f:
    import re
    lines = f.readlines()
    for line in lines:
        if line.startswith('VERSION = '):
            tag = re.split(r'\'|"', line)[1]
...
htmlhelp_basename = 'nsot_syncdoc'
...
latex_documents = [
    (master_doc, 'nsot_sync.tex', u'nsot\\_sync Documentation',
     u'Codey Oxley', 'manual'),
]
...
man_pages = [
    (master_doc, 'nsot_sync', u'nsot_sync Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nsot_sync', u'nsot_sync Documentation',
     author, 'nsot_sync', 'One line description of project.',
     'Miscellaneous'),
]
